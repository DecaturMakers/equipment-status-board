...
def register_handlers(bolt_app, app):
    ...
    def handle_esb_reserve(ack, body, client):
        ...
        with _ensure_app_context(app):
            ...
            availability = reservation_service.get_public_availability(now=now)
            client.views_open(
    ...
    def handle_reservation_view_mine(ack, body, client):
        ...
        with _ensure_app_context(app):
            ...
            reservations = reservation_service.list_user_upcoming_reservations(esb_user.id)
            client.views_update(
                view_id=body['view']['id'],
    ...
    def handle_reservation_cancel_confirm(ack, body, client):
        ...
        with _ensure_app_context(app):
            ...
            try:
                ...
                _update_reservation_error_modal(client, body, str(e))
                return
